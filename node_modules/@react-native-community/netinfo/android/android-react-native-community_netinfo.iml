...
<module external.linked.project.id=":react-native-community_netinfo" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="Gradle: androidx.annotation:annotation:1.2.0-beta01@jar" level="project" />
    ...
    <orderEntry type="library" name="Gradle: androidx.core:core:1.5.0-beta01@aar" level="project" />
